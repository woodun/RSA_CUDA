...
while(eob == 0 ):
    ...
    FindPairs (8256, n, current_bits, n_, r2, rmod, l, f1, f2, f4, 1, len(bits(current_bits) ) )
    f1.close()
    f2.close()
    f4.close()
    
    sum1 = subprocess.check_output(["./main", "bit1divpairs_pre.txt", "8256"])
    print(sum1)
    sum2 = subprocess.check_output(["./main", "nondivpairs_pre.txt", "8256"])
    print(sum2)
    sum3 = subprocess.check_output(["./main", "bit0divpairs_pre.txt", "8256"]) #./main bit0divpairs_pre.txt 1000
    print(sum3)
