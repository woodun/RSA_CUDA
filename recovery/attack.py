...
while(eob == 0 ):
    ...
    sum1 = subprocess.check_output(["./main", "bit1divpairs_pre.txt", "2000"])
    print(sum1)
    sum2 = subprocess.check_output(["./main", "nondivpairs_pre.txt", "2000"])
    print(sum2)
    sum3 = subprocess.check_output(["./main", "bit0divpairs_pre.txt", "2000"]) #./main bit0divpairs_pre.txt 1000
    print(sum3)
